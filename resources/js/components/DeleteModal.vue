                            ...
                            <div class="sm:flex sm:items-start">
                                ...
                                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    <h3 class="text-base font-semibold leading-6 text-gray-900" id="modal-title">Delete
                                        Product</h3>
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500">Are you sure you want to delete this product?
                                            All of your data will be permanently removed. This action cannot be undone.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row gap-4 sm:px-6 justify-center">
                            <button @click="$emit('deleteProduct')" type="button"
                            ...
                            <button type="button" @click="$emit('hideModal')"
...
<script setup>
defineEmits(['hideModal', 'deleteProduct'])
